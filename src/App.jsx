          ...
          {step==="feedback" && (
            <div>
              ...
              <div style={{ background:"#ef444411", border:"1px solid #ef444430", borderRadius:10, padding:"12px 16px", marginBottom:20, display:"flex", gap:10, alignItems:"flex-start" }}>
                ...
                <div>
                  <p style={{ margin:0, fontWeight:600, fontSize:13, color:"#f87171" }}>Your feedback stays private</p>
                  <p style={{ margin:"3px 0 0", fontSize:12, color:"#8b88a0", lineHeight:1.5 }}>This goes directly to the owner — not posted on Google. They'll use it to improve.</p>
                </div>
              </div>
